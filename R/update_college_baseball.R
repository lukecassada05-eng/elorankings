...
ALIASES <- c(
  ...
  "W. Kentucky"="Western Kentucky","W Kentucky"="Western Kentucky","Western KY"="Western Kentucky",
  ...
  "Jax St"="Jacksonville State","Jacksonville St."="Jacksonville State",
  ...
  "Central Mich"="Central Michigan","C Michigan"="Central Michigan","CMU"="Central Michigan",
  "E. Michigan"="Eastern Michigan","E Michigan"="Eastern Michigan",
  "Eastern Mich"="Eastern Michigan","EMU"="Eastern Michigan",
  "W. Michigan"="Western Michigan","W Michigan"="Western Michigan",
  "Western Mich"="Western Michigan","WMU"="Western Michigan",
  "N. Illinois"="Northern Illinois","N Illinois"="Northern Illinois",
  "Northern Ill"="Northern Illinois","NIU"="Northern Illinois","No. Illinois"="Northern Illinois",
  ...
  "Pepperdine"="Pepperdine","LMU"="Loyola Marymount","Loyola Marymount"="Loyola Marymount",
  "San Francisco"="San Francisco","USF"="South Florida",
  "Oregon St."="Oregon State",  # WCC affiliate 2024-25
  "Wash St."="Washington State",# WCC affiliate 2024-25
  # MVC
  ...
  "Evansville"="Evansville","Bradley"="Bradley","Valparaiso"="Valparaiso",
  "Belmont"="Belmont",
  # Horizon
  "Wright St"="Wright State","Wright St."="Wright State",
  "N. Kentucky"="Northern Kentucky","N Kentucky"="Northern Kentucky",
  "Oakland"="Oakland","Purdue FW"="Purdue Fort Wayne","Purdue Fort Wayne"="Purdue Fort Wayne",
  "IU Indy"="IU Indianapolis","IUPUI"="IU Indianapolis",
  "Milwaukee"="Milwaukee","Green Bay"="Green Bay",
  # Big South / CAA
  "Campbell"="Campbell","High Point"="High Point","Gardner-Webb"="Gardner-Webb",
  "Winthrop"="Winthrop","Longwood"="Longwood","Presbyterian"="Presbyterian",
  "SC Upstate"="SC Upstate","UNC Asheville"="UNC Asheville","Radford"="Radford",
  "Charleston So"="Charleston Southern","Ch. Southern"="Charleston Southern",
  "Charleston"="Charleston","Col. of Charleston"="Charleston",
  "Northeastern"="Northeastern","Delaware"="Delaware","Towson"="Towson",
  "UNC Wilmington"="UNC Wilmington","Elon"="Elon","Hofstra"="Hofstra",
  "Stony Brook"="Stony Brook","William & Mary"="William & Mary","Drexel"="Drexel",
  # SoCon
  "Mercer"="Mercer","Samford"="Samford","The Citadel"="The Citadel","Citadel"="The Citadel",
  "Furman"="Furman","Wofford"="Wofford","VMI"="VMI",
  ...
  "North Alabama"="North Alabama","North Florida"="North Florida","Queens"="Queens",
  ...
  "Utah Tech"="Utah Tech","Tarleton St"="Tarleton State",
  ...
  "Lamar"="Lamar","Hou Christian"="Houston Christian","Houston Baptist"="Houston Christian",
  ...
  "SC State"="South Carolina State","Texas Southern"="Texas Southern",
  "Miss Valley St"="Mississippi Valley State","Grambling"="Grambling",
  "Prairie View"="Prairie View A&M","Jackson St"="Jackson State",
  "AR-Pine Bluff"="Arkansas-Pine Bluff","Alcorn St"="Alcorn State",
  "Savannah St"="Savannah State","NC Central"="NC Central",
  # Ivy / Patriot / MAAC / A-10
  "Colgate"="Colgate","Fordham"="Fordham","Holy Cross"="Holy Cross",
  "Bucknell"="Bucknell","Lafayette"="Lafayette","Lehigh"="Lehigh","Army"="Army",
  ...
  "Wagner"="Wagner","Rider"="Rider","Bryant"="Bryant","Sacred Heart"="Sacred Heart",
  "Fairfield"="Fairfield","Monmouth"="Monmouth","Marist"="Marist",
  "Manhattan"="Manhattan","Canisius"="Canisius","Niagara"="Niagara","Siena"="Siena",
  "Quinnipiac"="Quinnipiac","Albany"="Albany","UAlbany"="Albany",
  "Binghamton"="Binghamton","Stony Brook"="Stony Brook",
  "Maine"="Maine","UMBC"="UMBC",
  "Seton Hall"="Seton Hall","St. John's"="St. John's","Georgetown"="Georgetown",
  "Providence"="Providence","Creighton"="Creighton","Xavier"="Xavier",
  "DePaul"="DePaul","Villanova"="Villanova","Butler"="Butler",
  "Marquette"="Marquette",
  "Rhode Island"="Rhode Island","URI"="Rhode Island",
  "UMass"="Massachusetts","Mass."="Massachusetts",
  "Richmond"="Richmond","Dayton"="Dayton","VCU"="VCU",
  "George Mason"="George Mason","Davidson"="Davidson",
  "Saint Joseph's"="Saint Joseph's","Saint Louis"="Saint Louis",
  "La Salle"="La Salle","Fordham"="Fordham","Duquesne"="Duquesne",
  "G Washington"="George Washington","GWU"="George Washington",
  "St Bonaventure"="St. Bonaventure","A-Sun"="ASUN",
  # Dallas Baptist
  ...
  "Little Rock"="Little Rock","Ark.-Little Rock"="Little Rock",
  "Seattle U"="Seattle","Seattle U."="Seattle",
  ...
  "G Washington"="George Washington","Geo Washington"="George Washington",
  "UMass Lowell"="UMass Lowell",
  "C Connecticut"="Central Connecticut State","Cent. Conn."="Central Connecticut State",
  "FDU"="Fairleigh Dickinson",
  "SIUE"="SIUE","SIU Edwardsville"="SIUE",
  "UT Martin"="UT Martin",
  "E Illinois"="Eastern Illinois","E. Illinois"="Eastern Illinois",
  "New Haven"="New Haven",
  # Misc
  "NJIT"="NJIT","FDU"="Fairleigh Dickinson","Sacred Heart"="Sacred Heart"
)
